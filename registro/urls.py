...
urlpatterns = [
    ...
    path("peliculas/<int:pelicula_id>/", views.pelicula_detail, name="pelicula_detail"),
    path("peliculas/<int:pelicula_id>/eliminar/", views.eliminar_pelicula, name="eliminar_pelicula"),
]
